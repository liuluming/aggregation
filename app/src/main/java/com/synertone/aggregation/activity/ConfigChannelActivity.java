...
import com.synertone.aggregation.bean.ChannelInfoModel;
...
public class ConfigChannelActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener,View.OnClickListener{
    ...
    private void doNetChannelConfig() {
        try {
            ...
            channelInfoBean.setUsername("");
            channelInfoBean.setPassword("");
            channelInfoBean.setEncrypt("");
            channelInfoBean.setCompress("");
